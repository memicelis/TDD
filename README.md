...
Clone this [repository](https://github.com/memicelis/TDD.git) to your desired folder.
...
- Clone this [repository](https://github.com/memicelis/TDD.git) in your local machine with correct branch.
